...
% Software written for the purpose of testing of the inconsistency indexes for incomplete matrixes contains comments. They were used to generate the documentation.
